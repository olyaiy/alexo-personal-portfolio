...
export function Hero() {
  return (
    <section className="container relative min-h-[calc(100vh-4rem)] mx-auto px-4 py-12 sm:px-6 lg:px-8 flex items-center">
      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
        ...
        >
          <div className="space-y-8">
            <motion.span
              ...
              className="inline-flex items-center px-6 py-2.5 bg-primary/10 text-primary rounded-full text-sm font-semibold mb-4 hover:bg-primary/15 transition-all duration-300 cursor-pointer shadow-lg shadow-primary/10"
            >
        ...
        >
          <div className="aspect-square w-full rounded-3xl glass-card p-2 
          ...
          <motion.div 
            ...
            className="absolute -bottom-8 -left-8 h-48 w-48 rounded-full bg-primary/20 blur-[32px] group-hover:bg-primary/30 transition-colors duration-500" 
          />
          <motion.div 
            animate={{ 
              scale: [1, 1.2, 1],
            ...
            className="absolute -top-8 -right-8 h-56 w-56 rounded-full bg-secondary/15 blur-[40px] group-hover:bg-secondary/25 transition-colors duration-500" 
          />
        </motion.div>
      </div>
    </section>
