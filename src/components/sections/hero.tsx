...
export const SOCIAL_LINKS = [
  ...
  { icon: InstagramFilledIcon, href: "https://www.instagram.com/alex_intelligence_/", label: "Instagram" },
  { icon: TikTokFilledIcon, href: "https://www.tiktok.com/@ai_with_alexan", label: "TikTok" },
] as const
